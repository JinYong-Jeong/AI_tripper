...
interface DaejeonCentralMarketPageProps {
...
export default function DaejeonCentralMarketPage({ onNavigate, onNationalStamp, onGusukTour }: DaejeonCentralMarketPageProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      title: '트리퍼 in 대전',
      type: 'region',
      action: () => onGusukTour(), // 구석투어_대전 페이지로 이동
      children: [
        { 
          id: 'science-museum', 
          title: '국립중앙과학관', 
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen p-6 pt-24">
        ...
        >
          <h1 className="font-gmarket-bold text-4xl mb-4 text-gray-800">
            <span className="hidden sm:inline">트리퍼 in 대전중앙시장</span>
            <span className="sm:hidden">
              트리퍼 in<br />대전중앙시장
            </span>
          </h1>
          <p className="text-lg text-gray-600">대전의 전통과 맛을 한 자리에서 경험해보세요!</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
          ...
          >
            <Card 
              ...
              onClick={() => onNavigate('daejeon-central-market-guide')}
            >
              {/* 이미지 섹션 */}
          ...
          >
            <Card 
              ...
              onClick={() => onNavigate('daejeon-central-market-stamp')}
            >
              {/* 이미지 섹션 */}
              <div className="relative h-40 overflow-hidden">
              ...
              <div className="p-5 bg-gradient-to-b from-red-50 to-pink-50">
                <div className="text-center">
                  ...
                  <p className="text-red-700 text-sm leading-relaxed">
                    시장에서 미션을 완료하고 스탬프를 수집하여<br />
                    특별한 할인 혜택과 기념품을 받아보세요!
                  </p>
                </div>
              </div>
